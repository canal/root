/**
 * Class:   casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel
 *
 ...
 *
 */
Ext.namespace("casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel");
casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel = Ext.extend(Ext.Panel,
{
  ID:undefined,
  ...
  constructor: function(config)
  {
    ...
    casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel.superclass.constructor.call(this, defaults);
  }
});
Ext.reg('casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel', casetracking.search.advanced.ux.panel.results.common.ResultsContentPanel);
