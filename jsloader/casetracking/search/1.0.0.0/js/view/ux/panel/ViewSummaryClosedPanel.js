Ext.namespace("casetracking.search.view.ux.panel.ViewSummaryClosedPanel");
casetracking.search.view.ux.panel.ViewSummaryClosedPanel = Ext.extend(Ext.Panel,
{
  NAMESPACE:undefined,
  RENDERTO:undefined,
  ...
  constructor: function(config)
  {
					                 ...
					                 {	
					                	 ...
					                	 ,renderer: function(val) {
											if(val && val.time){
												var dateClosedOn = '';
												if (val != null) {
													dateClosedOn = new Date(val.time.time);
													dateClosedOn = dateClosedOn.format('m/d/Y');
												}		
												return dateClosedOn;
											}else{
												return val;
	...
	this.GRIDVIEW = new Ext.grid.GridView({ 
		...
		,emptyText:'<div align="center" class="casetrackingGridEmpty"><BR><b>No closed service cases</b></div>'
	});         
	...
	function isRowChangedToday(lastExternalModifyDate, lastModifyDate) {
		...
		}else if(thisObj.USERCLASSCODE == "PRV"){
			dataField = lastExternalModifyDate;
		}
    ...
    casetracking.search.view.ux.panel.ViewSummaryClosedPanel.superclass.constructor.call(this, defaults);
    
  } //End of Constructor
});
Ext.reg('casetracking.search.view.ux.panel.ViewSummaryClosedPanel', casetracking.search.view.ux.panel.ViewSummaryClosedPanel);
