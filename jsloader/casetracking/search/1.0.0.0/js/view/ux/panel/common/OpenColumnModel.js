Ext.namespace("casetracking.search.view.ux.panel.common.OpenColumnModel");
casetracking.search.view.ux.panel.common.OpenColumnModel = Ext
		.extend(
				Ext.grid.ColumnModel,
				{
					...
					constructor : function(config) {
						...
						var defaults = {
							columns : [
									...
									},
									{
										header : 'Reopened On',
										sortable : true,
										dataIndex : "reopenOnDate",
										width : 65,
										renderer : function(val) {
											if (val && val.time) {
												var dateReopenedOn = '';
												if (val != null) {
													dateReopenedOn = new Date(
															val.time.time);
													dateReopenedOn = dateReopenedOn
															.format('m/d/Y');
												}
												return dateReopenedOn;
											} else {
												return val;
											}
										}
						...
						casetracking.search.view.ux.panel.common.OpenColumnModel.superclass.constructor
								.call(this, defaults);

					} // End of Constructor
				});
Ext.reg('casetracking.search.view.ux.panel.common.OpenColumnModel',
		casetracking.search.view.ux.panel.common.OpenColumnModel);